...
if __name__ == '__main__':
    ...
    print("top 10 accuracy", str(sum(accumulated_rank10)/len(accumulated_rank10)))
    print("top 30 accuracy", str(sum(accumulated_rank30)/len(accumulated_rank30)))
    print("top 50 accuracy", str(sum(accumulated_rank50)/len(accumulated_rank50)))
