...
print("the length of genes",len(mouse_to_human.keys()))
...
total_gene_go=set()
total_gene_go_id=set()
total_gene_go_final=set()
number_gene_id=0
...
print("the length of gene and go association")
print(len(gene_go_feature))
print("total gene id",len(total_gene_go_id))


# obtain the mammalian phenotypes and gene association

mp_pheno=pd.read_table("data/MGI_GenePheno.rpt",names=["Allelic_Composition","Allele_Symbol","Allele_ID","Genetic_Background","Mammalian_Phenotype_ID","PubMed_ID","MGI_Marker","MGI_Genotype_Accession"])
gene_mp_feature=dict()

total_mouse_gene_before=set()
for index in mp_pheno.index:
    mouse_gene=mp_pheno.loc[index,"MGI_Marker"].strip()
    total_mouse_gene_before.add(mouse_gene)
...
print("the length of mouse gene and phenotypes")
print(len(mp_pheno))
print("total mouse gene before",len(total_mouse_gene_before))


# obtain the gene and uberon associations
gene_expression=pd.read_table("data/E-MTAB-5214-query-results.tpms.tsv")
...
gene_uberon_feature= gene_uberon_feature_4_0
...
generate_features(mouse_gene_disease,gene_uberon_feature_1_0,dis_phe,"uberon_1_0")
generate_features(mouse_gene_disease,gene_uberon_feature_2_0,dis_phe,"uberon_2_0")
generate_features(mouse_gene_disease,gene_uberon_feature_3_0,dis_phe,"uberon_3_0")
generate_features(mouse_gene_disease,gene_uberon_feature_4_0,dis_phe,"uberon_4_0")
generate_features(mouse_gene_disease,gene_uberon_feature_5_0,dis_phe,"uberon_5_0")
generate_features(mouse_gene_disease,gene_uberon_feature_6_0,dis_phe,"uberon_6_0")
